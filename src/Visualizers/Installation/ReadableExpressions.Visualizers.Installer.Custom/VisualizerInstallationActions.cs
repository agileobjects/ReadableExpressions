        ...
        out string errorMessage)
    {
        ...
        installers = _thisAssembly
            ...
            .Select(visualizerResourceName => 
                new Visualizer(Log, CoreAssemblies, visualizerResourceName))
            .OrderByDescending(visualizer => visualizer.VsFullVersion)
            .SelectMany(installerFactory.GetInstallersFor)
            .ToList();
