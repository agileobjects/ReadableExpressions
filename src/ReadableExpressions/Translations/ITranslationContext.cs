...
public interface ITranslationContext
{
    ...
    /// <summary>
    /// Gets the <see cref="INodeTranslation"/> for the given <paramref name="expression"/>.
    /// </summary>
    /// <param name="expression">The Expression for which to get an <see cref="INodeTranslation"/>.</param>
    /// <returns>The <see cref="INodeTranslation"/> for the given <paramref name="expression"/>.</returns>
    INodeTranslation GetTranslationFor(Expression expression);
}