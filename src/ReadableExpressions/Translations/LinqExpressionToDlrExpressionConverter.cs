...
public static class LinqExpressionToDlrExpressionConverter
{
    ...
    private class Converter
    {
        ...
        private Expression ConvertCast(
            LinqExp.UnaryExpression linqConvert,
            Func<Expression, Type, MethodInfo, Expression> factory)
        {
            return factory.Invoke(
        ...
        private Expression Convert(
            LinqExp.UnaryExpression linqUnary,
        ...
        private Expression Convert(
            LinqExp.UnaryExpression linqUnary,
            Func<Expression, Type, Expression> factory)
        {
            return factory.Invoke(ConvertExp(linqUnary.Operand), linqUnary.Type);
        }

        private Expression ConvertImplicit(
        ...
        private IEnumerable<Expression> Convert(
            IEnumerable<LinqExp.Expression> linqExpressions)
        {
